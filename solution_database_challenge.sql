...
CREATE TABLE AverageLifeExpectancy (
	LifeProm INT NOT NULL,
    Region VARCHAR(30)
);

INSERT INTO AverageLifeExpectancy
SELECT ROUND(AVG(c.LifeExpectancy)) as LifeProm, c.Continent as Region
FROM country as c
WHERE c.Continent IN ('South America','North America','Asia')
